...
import ui.TogglePlayButton;
import ui.UserInterface;
import simulation.World;
import rocket.PIDRocket;
import rocket.Rocket;
import simulation.ColorPalette;
import util.KeyboardControls;
...
public class Simulation extends Application {
	...
	private KeyboardControls keyboardHandler;
	...
	public void init() {
		...
		keyboardHandler = new KeyboardControls(userRocket);
	...
	private class MenuManager {
		...
		public void showTitleScreen(Stage stage) {
			...
			Button startComputerButton = new Button("Automatic Landing (PID Controller)");
			startComputerButton.setPrefSize(350, getButtonHeight());
			...
			Button startUserButton = new Button("Interactive Landing (User Control)");
			startUserButton.setPrefSize(350, getButtonHeight());
		...
		public Group getLandingSummary() {
			...
			Rectangle backgroundBox = new Rectangle(WIDTH / 2 - backgroundBoxWidth / 2, 
														...
														backgroundBoxWidth, 
														backgroundBoxHeight);
			backgroundBox.setArcWidth(10);
			backgroundBox.setArcHeight(10);
		 ...
		 */
		public void startPIDSimulation(Stage stage) {
